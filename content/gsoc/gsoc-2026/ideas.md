...
You can also find us in [Slack](https://gsoc-slack.honeynet.org/).
...
If you are considering applying to participate with us in GSoC 2026 please find our [application template here]({{< ref "application.md" >}}). Use it when you are preparing your application on the official GSoC site and don't hesitate to ask your mentors for feedback before submitting!
